      ...
      Label3: {
        F.line = 129;
          ...
          if (!(i_687865912 < n_p3)) break Label4;
            F.line = 50;
            F.filename = "digitsutils.nim";
            iHEX60gensym4_318767326 = i_687865912;
            F.line = 47;
            ...
            F.line = 131;
            F.filename = "iterators_1.nim";
            i_687865912 = addInt(i_687865912, 1);
          }
      };
    };
  framePtr = F.prev;
...
F.line = 61;
failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(13, 3) `data.hasKey(\"key0\")` "));
}

if (!((data_687865859.get("key0") == "value0"))) {
F.line = 61;
failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(14, 3) `data[\"key0\"] == \"value0\".cstring` "));
}
...
F.line = 61;
failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsformdata_examples_1.nim(16, 3) `data.len == 0` "));
}
