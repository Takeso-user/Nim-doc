...
NTI1006633071.base = NTI33555157;
...
NTI1006633102.base = NTI33555157;
...
NTI1006633029.base = NTI33555157;
...
NTI1023410180.base = NTI33555167;
...
function reprEnum(e_p0, typ_p1) {
  ...
  framePtr = F;
    ...
    var tmp_33557641 = false;
    F.line = 31;
    var item_33557642 = typ_p1.node.sons[e_p0];
    F.line = 32;
    tmp_33557641 = item_33557642 !== undefined;
    if (tmp_33557641) {
    F.line = 34;
    result_33557640 = nimCopy(null, makeNimstrLit(item_33557642.name), NTI33554449);
    }
    else {
      F.line = 36;
      result_33557640 = nimCopy(null, (HEX24__systemZdollars_u14(e_p0)).concat([32,40,105,110,118,97,108,105,100,32,100,97,116,97,33,41]), NTI33554449);
    }
    
  framePtr = F.prev;

  return result_33557640;
      ...
      Label3: {
        F.line = 129;
          ...
          if (!(i_687866314 < n_p3)) break Label4;
            F.line = 50;
            F.filename = "digitsutils.nim";
            iHEX60gensym4_318767326 = i_687866314;
            F.line = 47;
            ...
            F.line = 131;
            F.filename = "iterators_1.nim";
            i_687866314 = addInt(i_687866314, 1);
          }
      };
    };
  framePtr = F.prev;
...
async function example__jsfetch95examples951_u202() {
  ...
  BeforeRet: {
    ...
    F.line = 119;
    failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(77, 9) `response.ok` "));
    }
    
    if (!((response_687866070.status == 200))) {
    F.line = 119;
    failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(78, 9) `response.status == 200.cint` "));
    }
    
    if (false) {
    F.line = 119;
    failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(79, 9) `response.headers is Headers` "));
    }
    
    if (false) {
    F.line = 119;
    failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(80, 9) `response.body is cstring` "));
    }
...
Label1: {
  ...
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(28, 5) `options0.keepalive == false` "));
  }
  
  if (!((options0_687865866.method == "POST"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(29, 5) `options0.metod == \"POST\".cstring` "));
  }
  
  if (!((options0_687865866.body == "{\"key\": \"value\"}"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(30, 5) `options0.body == \"\"\"{\"key\": \"value\"}\"\"\".cstring` "));
  }
  
  if (!((options0_687865866.mode == "no-cors"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(31, 5) `options0.mode == \"no-cors\".cstring` "));
  }
  
  if (!((options0_687865866.credentials == "omit"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(32, 5) `options0.credentials == \"omit\".cstring` "));
  }
  
  if (!((options0_687865866.cache == "no-cache"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(33, 5) `options0.cache == \"no-cache\".cstring` "));
  }
  
  if (!((options0_687865866.referrerPolicy == "no-referrer"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(34, 5) `options0.referrerPolicy == \"no-referrer\".cstring` "));
  }
  
  if (!((options0_687865866.redirect == "follow"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(35, 5) `options0.redirect == \"follow\".cstring` "));
  }
  
  if (!((options0_687865866.referrer == "client"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(36, 5) `options0.referrer == \"client\".cstring` "));
  }
  
  if (!((options0_687865866.integrity == ""))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(37, 5) `options0.integrity == \"\".cstring` "));
  }
  
  if (!((Array.from(options0_687865866.headers.entries()).length == 0))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(38, 5) `options0.headers.len == 0` "));
  }
...
Label2: {
  ...
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(54, 5) `options1.keepalive == false` "));
  }
  
  if (!((options1_687865922.method == "POST"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(55, 5) `options1.metod == $HttpPost` "));
  }
  
  if (!((options1_687865922.body == "{\"key\": \"value\"}"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(56, 5) `options1.body == \"\"\"{\"key\": \"value\"}\"\"\".cstring` "));
  }
  
  if (!((options1_687865922.mode == "no-cors"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(57, 5) `options1.mode == $fmNoCors` "));
  }
  
  if (!((options1_687865922.credentials == "omit"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(58, 5) `options1.credentials == $fcOmit` "));
  }
  
  if (!((options1_687865922.cache == "no-cache"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(59, 5) `options1.cache == $fchNoCache` "));
  }
  
  if (!((options1_687865922.referrerPolicy == "no-referrer"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(60, 5) `options1.referrerPolicy == $frpNoReferrer` "));
  }
  
  if (!((options1_687865922.redirect == "follow"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(61, 5) `options1.redirect == $frFollow` "));
  }
  
  if (!((options1_687865922.referrer == "client"))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(62, 5) `options1.referrer == \"client\".cstring` "));
  }
  
  if (!((options1_687865922.integrity == ""))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(63, 5) `options1.integrity == \"\".cstring` "));
  }
  
  if (!((Array.from(options1_687865922.headers.entries()).length == 0))) {
  F.line = 119;
  failedAssertImpl__stdZassertions_u81(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsfetch_examples_1.nim(64, 5) `options1.headers.len == 0` "));
  }
